...
sayHello();
echo '<h2> Arithetic problems-cubes </h2>';
...
function area_volume2($a,$b,$c) {
    ...
    echo '<b>This is my volyme:</b> '.$volume.' <br>';
...
$my_return.='<li><a href="' .$key.'"> '.$value.'</a> </li>';
    ...
    echo '<h2>Our Navigation with fuction!</h2>';
    echo make_links($nav);
           
    echo '<h2>The implode function</h2>';

    $cars = array('toyota','ford','suburu','lexus');

 $my_car=implode(',' ,$cars);
 echo $my_cars;

 echo '<h2>  The logic hehind the wines on our form</h2>
 <p>If post wines is not empty, take post wines and implode 
 them and create a new varible name $my_wines</p>
 ';